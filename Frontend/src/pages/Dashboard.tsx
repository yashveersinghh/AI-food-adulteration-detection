    ...
    <div className="container mx-auto px-4 py-12 max-w-6xl animate-in fade-in duration-500">
      ...
      <div className="flex flex-col items-center text-center space-y-6 mb-16">
        <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-balance max-w-4xl">
          Secure the food supply chain with <span className="text-[#EBACFC]">Multimodal AI</span>
        </h1>
        ...
        <div className="pt-4">
          <Button 
            onClick={onStart} 
            size="lg" 
            className="bg-white rounded-full cursor-pointer text-black font-medium text-lg px-8 py-6 h-auto shadow-lg shadow-[#EBACFC] transition-all hover:scale-102 active:scale-98"
      ...
      <div className="space-y-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="bg-card/50 border border-border rounded-xl p-6 hover:bg-card hover:border-white transition-colors group">
